...
def get_args():
    ...
    parser.add_argument("--lr-actor", type=float, default=0.0001, help="learning rate of actor")  # 0.00007
    parser.add_argument("--lr-critic", type=float, default=0.0001, help="learning rate of critic")
